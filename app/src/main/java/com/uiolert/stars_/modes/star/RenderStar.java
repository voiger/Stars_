...
public class RenderStar {
    ...
    public void draw(Canvas canvas, ModelStar modelStar) {
        ...
        for (Point point : modelStar.getPoints()) {
            ...
            if (sx2 < canvas.getWidth() && sx2 >= 0
                ...
                float colorGain = ((float) (255 + (int) (point.z * (255 / Math.abs(ModelStar.INITIAL_Z_COORD))))) / 255f;
